...
CREATE TABLE `detalles_pedidos` (
  ...
  CONSTRAINT `detalles_pedidos_ibfk_1` FOREIGN KEY (`pedidos_id`) REFERENCES `pedidos` (`pedidos_id`),
  CONSTRAINT `detalles_pedidos_ibfk_2` FOREIGN KEY (`productos_id`) REFERENCES `productos` (`productos_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pedidos` (
  ...
  CONSTRAINT `pedidos_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `users` (`usuario_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos` VALUES (1,1,'Jean cargo baggy','Pantalon de jean cargo baggy',30,'Kiech','Mujer','https://acdn.mitiendanube.com/stores/001/497/956/products/8-f64e9408a2acbd5dad17258334074051-1024-1024.webp','2024-09-13','https://acdn.mitiendanube.com/stores/001/497/956/products/7-9f4c293f1401bc5aca17258334069651-1024-1024.webp',NULL),(2,2,'Hoodie love','Hoodie de corte boxy fit con bordado',20000,'Kiech','Hombre','https://acdn.mitiendanube.com/stores/001/497/956/products/1-c6124a31f902aeffc517258163877937-1024-1024.webp','2024-09-13','https://acdn.mitiendanube.com/stores/001/497/956/products/2-3fc33741afe2b8552a17258163871547-1024-1024.webp',NULL),(3,3,'Body MB','Body manga larga de tricot con cierre invisible ',5000,'Kiech','Mujer','https://acdn.mitiendanube.com/stores/001/497/956/products/23-49ef3cba535618d6ef17227330424354-1024-1024.webp','2024-09-13','https://acdn.mitiendanube.com/stores/001/497/956/products/22-05b768235cd197eeb917227330418618-1024-1024.webp',NULL),(4,2,'Buzo Crewneck Fmily','Buzo crewneck Fmily corte BOXY de algodòn con friza premium',20000,'Kiech','Hombre','https://acdn.mitiendanube.com/stores/001/497/956/products/17-13a8857b637c05643517227262206931-1024-1024.webp','2024-09-20','https://acdn.mitiendanube.com/stores/001/497/956/products/16-07027be10f64b4393a17227262212941-1024-1024.webp',NULL),(5,4,'Remera cali','Remera Cali de algodòn con lycra pesada de corte Boxy fit',40000,'kiech','Hombre','https://acdn.mitiendanube.com/stores/001/497/956/products/7-4111e5c5e94acfc8a817227398730408-1024-1024.webp','2024-10-04','https://acdn.mitiendanube.com/stores/001/497/956/products/8-d373949a0457369dd717227398725588-1024-1024.webp','Remera Cali confeccionada en algodòn con lycra pesada de corte BOXY fit. Tiene bordado en el delantero y una amplia estampa en la espalda.'),(6,4,'Remera YB','Remera oversize de algodòn con lycra 24/1',35000,'kiech','Hombre','https://acdn.mitiendanube.com/stores/001/497/956/products/_dsc6172-1-d7cf6efb97f448788e17038722190738-1024-1024.webp','2024-10-04','https://acdn.mitiendanube.com/stores/001/497/956/products/_dsc6169-1-375452241512d2ebd317038723352513-1024-1024.webp','Remera oversize de algodòn con lycra 24/1 con estampa en pecho y espalda. ');
...
INSERT INTO `users` VALUES (1,'nicolas','oddo','nicolasoddo@gmail.com','eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee',12345678),(2,'nicolas','oddo','nicolasoddo07@gmail.com','',12345678),(3,'nicolas','oddo','nicolasoddo073@gmail.com','nicoloco',12345678),(4,'pedro','perez','nose@gmail.com','holasoypedro123',1234567844);
...
-- Dump completed on 2024-10-04 17:49:03
